...
/**
 * OpsDesk transport mediums (managed from the Settings tab).
 */
class Opsdesk_transport_mediums_model extends App_Model
{
    private $table;
    ...
    {
        parent::__construct();
        $this->table = db_prefix() . 'opsdesk_transport_mediums';
    }

    /**
     * Get transport medium(s), ordered by display_order.
     *
     * @param int|string $id
     * @return array|null
     */
